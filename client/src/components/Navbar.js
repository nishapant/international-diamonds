...
import { Drawer, Button, Menu, Input, Badge } from 'antd';
        ...
        <div style={{paddingBottom: "10px", borderBottom: '1px solid lightgray'}}>
            ...
            <nav className="menuBar">
                <div className="menuCon">
                    ...
                    <div className="searchMenuMobile" style={{marginTop: '10px'}}>   
                        <Search
                            placeholder="SEARCH"
                        ...
                        />
                         <Link to="/checkout" >
                            <Badge count={cartItemsLength}>
                                <ShoppingCartOutlined  style={{ fontSize: '20px', color: '#686868', marginLeft: '10px' }} />
                            </Badge>
                        </Link>
